    ...
    */
    ...
    if (rl["failed"]) {
        ...
        let table_list = [
                ...
                ['Fraction of putatively essential genes with good hits', prepNum(rl['essential_hit_rate']) ],
                ['Fraction of non-essential (putative) genes with good hits', prepNum(rl['other_hit_rate'])],
